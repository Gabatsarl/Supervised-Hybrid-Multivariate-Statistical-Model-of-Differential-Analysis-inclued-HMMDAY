...
save(list = ls(), file ="/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario_ST3.3.RData")

## Boxplot(RESULT$LAMBDA[,1])    

load("/Users/fatimaakpo/Downloads/Student/simul_no_data_Small_Scenario_ST3.3.RData")
...
print(result_plot)
ggsave("/Users/fatimaakpo/Downloads/qqplot_scenario_ST3.3.pdf",plot=result_plot,
...
gplot3.3 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 10%"), 
       x = "", 
       y = "Impact Factor") +
  theme_pubr() +
...
ggsave("/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario_ST3.3.pdf",plot=gplot3.3,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")


## QQplot et les volcano plot
...
gplot_des_3.3_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 10%"), 
       x = "", 
       y = "RMSE") +
  ...
  scale_fill_discrete(guide = "none") +
  theme(plot.title = element_text(hjust = 0.5))+  # Centrer le titre
  coord_cartesian(ylim = c(0, 4500))  # Fixer les limites de l'axe y


gplot_des_3.3_MSE


ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario_des_ST3.3.pdf",plot=gplot_des_3.3_MSE,
...
gplot_des_3.3_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 10%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario_ST3.3.pdf",plot=gplot_des_3.3_R2,
       width = 4, height = 2.8, units = "in", dpi = 300,bg = "white")
