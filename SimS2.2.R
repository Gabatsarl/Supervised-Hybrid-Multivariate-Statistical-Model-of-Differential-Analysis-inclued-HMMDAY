...
n_samples<-150 # n_sample/n_taxa=5%
n_taxa<-3000
n_signif<-90
...
RESULT<-simulation_NB(B=300, # nombre de simulation,
                      ...
                      groups=groups)
save(list = ls(), file ="/Users/timakpo/Downloads/simul_no_data_Small_Scenario_ST2.2.RData")
...
gplot2.2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 1%"), 
       x = "", 
       y = "Impact Factor") +
  theme_pubr() +
  ...
  coord_cartesian(ylim = c(0, 1.5)) # Fixer les limites de l'axe y


gplot2.2

ggsave("/Users/timakpo/Downloads/simul1_nodata_2.2.pdf",plot=gplot2.2,
...
load("/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario2.2.RData")
...
gplot2.2_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 5%"), 
       x = "", 
       y = "RMSE") +
  theme_pubr() +
  scale_fill_discrete(guide = "none") +
...
ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario2.2.pdf",plot=gplot2.2_MSE,
...
gplot2.2_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 5%"), 
       x = "", 
       y = "R2") +
  ...
  scale_fill_discrete(guide = "none") +
  theme(plot.title = element_text(hjust = 0.5))+  # Centrer le titre
  coord_cartesian(ylim = c(0, 0.05))  # Fixer les limites de l'axe y


gplot2.2_R2

ggsave("/Users/fatimaakpo/Downloads/R2_scenario2.2.pdf",plot=gplot2.2_R2,
       width = 4, height = 2.8, units = "in", dpi = 300,bg = "white")
...
save(list = ls(), file ="/Users/fatimaakpo/Downloads/simul_no_data_desequilibre_Scenario2.2.RData")
...
gplot2.1_deseq <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
...
ggsave("/Users/timakpo/Downloads/simul1_nodata_desequi_2.1.pdf",plot=gplot2.1_deseq,
...
load("/Users/fatimaakpo/Downloads/Simulation_Part2/simul_no_data_Desequilibre_Scenario2.2.RData")
...
gplot2.2_des <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 5%"), 
       x = "", 
       y = "Impact Factor") +
...
ggsave("/Users/fatimaakpo/Downloads/simul1_nodata_deseq_2.2.pdf",plot=gplot2.2_des,
       width = 4.2, height = 3.2, units = "in", dpi = 300,bg = "white")
...
gplot_des_2.2_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 5%"), 
       x = "", 
       y = "RMSE") +
...
ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario_des_2.2.pdf",plot=gplot_des_2.2_MSE,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")
...
gplot_des_2.2_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 5%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario_des_2.2.pdf",plot=gplot_des_2.2_R2,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")
