...
RESULT<-simulation_NB(B=300, # nombre de simulation,
                      ...
                      groups=groups)
save(list = ls(), file ="/Users/timakpo/Downloads/simul_no_data_Small_Scenario_ST2.3.RData")
...
gplot2.3 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "Impact Factor") +
  theme_pubr() +
...
ggsave("/Users/timakpo/Downloads/simul1_nodata_2.3.pdf",plot=gplot2.3,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")


###======= Calcul des biais ============ ###

load("/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario2.3.RData")
...
gplot2.3_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "RMSE") +
...
ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario2.3.pdf",plot=gplot2.3_MSE,
...
gplot2.3_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario2.3.pdf",plot=gplot2.3_R2,
       width = 4, height = 2.8, units = "in", dpi = 300,bg = "white")
...
RESULT<-simulation_NB(B=300, # nombre de simulation,
                      ...
                      sigma=sigma, # probabilité de zero dans les données (dimemsion)
                      groups=groups)
save(list = ls(), file ="/Users/fatimaakpo/Downloads/simul_no_data_desequilibre_Scenario2.3.RData")
...
load("/Users/fatimaakpo/Downloads/Simulation_Part2/simul_no_data_Desequilibre_Scenario2.3.RData")
...
gplot2.3_des <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "Impact Factor") +
...
ggsave("/Users/fatimaakpo/Downloads/simul1_nodata_deseq_2.3.pdf",plot=gplot2.3_des,
...
gplot_des_2.3_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "RMSE") +
...
ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario_des_2.3.pdf",plot=gplot_des_2.3_MSE,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")
...
gplot_des_2.3_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.05, " * n/p * " = 5%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario_des_2.3.pdf",plot=gplot_des_2.3_R2,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")
