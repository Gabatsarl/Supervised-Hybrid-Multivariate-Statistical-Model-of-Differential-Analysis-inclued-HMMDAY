...
save(list = ls(), file ="/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario_ST3.2.RData")

#boxplot(RESULT$LAMBDA[,1])    

## Load the data
load("/Users/fatimaakpo/Downloads/Student/simul_no_data_Small_Scenario_ST3.2.RData")
...
gplot3.2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 10%"), 
       x = "", 
       y = "Impact Factor") +
  theme_pubr() +
...
ggsave("/Users/fatimaakpo/Downloads/simul_no_data_Small_Scenario_ST3.2.pdf",plot=gplot3.2,
...
ggsave("/Users/fatimaakpo/Downloads/qqplot_scenario_ST3.2.pdf",plot=result_plot,
       width = 4.2, height = 3, units = "in", dpi = 300,bg = "white")
...
gplot3.2_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 10%"), 
       x = "", 
       y = "RMSE") +
  ...
  scale_fill_discrete(guide = "none") +
  theme(plot.title = element_text(hjust = 0.5))+  # Centrer le titre
  coord_cartesian(ylim = c(0, 3000))  # Fixer les limites de l'axe y


gplot3.2_MSE


ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario_ST3.2.pdf",plot=gplot3.2_MSE,
...
gplot3.2_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.03, " * n/p * " = 10%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario_ST3.2.pdf",plot=gplot3.2_R2,
       width = 4, height = 2.8, units = "in", dpi = 300,bg = "white")
