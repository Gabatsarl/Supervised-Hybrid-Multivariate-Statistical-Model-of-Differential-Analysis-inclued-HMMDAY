...
RESULT<-simulation_NB(B=300, # nombre de simulation,
                      ...
                      groups=groups)
save(list = ls(), file ="/Users/timakpo/Downloads/simul_no_data_Small_Scenario_ST2.1.RData")



### Figure
load("/Users/fatimaakpo/Downloads/Student/simul_no_data_Small_Scenario_ST2.1.RData")
...
gplot2.1 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.01, " * n/p * " = 5%"), 
       x = "", 
       y = "Impact Factor") +
  theme_pubr() +
...
ggsave("/Users/fatimaakpo/Downloads/simul1_nodata_ST2.1.pdf",plot=gplot2.1,
...
print(result_plot)
ggsave("/Users/fatimaakpo/Downloads/qqplot_scenario_ST2.1.pdf",plot=result_plot,
...
gplot2.1_MSE <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.01, " * n/p * " = 5%"), 
       x = "", 
       y = "RMSE") +
  ...
  scale_fill_discrete(guide = "none") +
  theme(plot.title = element_text(hjust = 0.5))+  # Centrer le titre
  coord_cartesian(ylim = c(0, 2500))  # Fixer les limites de l'axe y


gplot2.1_MSE


ggsave("/Users/fatimaakpo/Downloads/RMSE_scenario_ST2.1.pdf",plot=gplot2.1_MSE,
...
gplot2.1_R2 <- ggplot(data_long, aes(x = Var2, y = value, fill = Var2)) + 
  geom_boxplot(outlier.shape = NA) +
  labs(title = expression("" * tau * " = 0.01, " * n/p * " = 5%"), 
       x = "", 
       y = "R2") +
...
ggsave("/Users/fatimaakpo/Downloads/R2_scenario_ST2.1.pdf", 
       plot=gplot2.1_R2, width = 4, height = 2.8, 
